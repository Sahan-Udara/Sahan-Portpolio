      ...
      <div className='relative grid w-full h-full grid-cols-2 bg-center bg-no-repeat bg-cover rounded-3xl border-4 border-[#8d4aea]' style={{ backgroundImage: `url(${Background})` }}>
        <div className='w-full h-full m-4 md:ml-20 md:my-20'>
          ...
          <div className='flex flex-row gap-2 mr-8 '>
            <button className='py-2 px-3 md:py-3 md:px-6 bg-[#8d4aea] text-[#ffffff] rounded-lg text-[10px] font-bold md:text-[18px]'>Say Hello</button>
            <button className='py-2 px-3 md:py-3 md:px-6 text-[#ffffff] rounded-lg border hover:border-[#8d4aea] text-[10px] md:text-[18px] font-bold'>My Work</button>
          </div>
        </div>
